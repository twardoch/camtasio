...
class MockMedia:
    ...
    def copy(self):
        ...
        # Return a new instance with the same ID
        # The duplicate_media function will handle assigning the new ID
        return MockMedia(self.id, self.name)
...
class TestAddMediaToTrack:
    ...
    def test_add_media_to_track_success(self):
        ...
        track_media = next(iter(track.medias.values()))
...
class TestMediaOperationsIntegration:
    ...
    def test_duplicate_and_reference_workflow(self):
        ...
        # Duplicate media
        duplicate_media(project, "media1", "media1_dup")
