...
class TestCalloutDataStructure:
    ...
    def test_text_callout_required_fields(self):
        ...
        required_fields = [
            "kind", "shape", "style", "height", "width", "text",
            "horizontal-alignment", "vertical-alignment", "font",
            "textAttributes", "line-spacing", "word-wrap", "resize-behavior"
        ]
        ...
        font_fields = ["color-red", "color-green", "color-blue", "size", "name", "weight", "tracking"]
    ...
    def test_square_callout_required_fields(self):
        ...
        required_fields = [
            ...
            "stroke-color-red", "stroke-color-green", "stroke-color-blue", "stroke-color-opacity",
            "stroke-width", "fill-style", "stroke-style", "tail-x", "tail-y"
        ]
...
class TestAnnotationBoundaryValues:
    ...
    def test_callout_extreme_dimensions(self):
        ...
        callout = text_callout(
            "Test", "Arial", "normal",
            height=1.0, width=1.0, font_size=1.0
        )
        ...
        callout = text_callout(
            "Test", "Arial", "normal",
            height=10000.0, width=10000.0, font_size=1000.0
        )
...
class TestAnnotationEdgeCases:
    ...
    def test_callout_negative_dimensions(self):
        ...
        callout = text_callout(
            "Test", "Arial", "normal",
            height=-100.0, width=-200.0, font_size=-10.0
        )
    ...
    def test_callout_zero_dimensions(self):
        ...
        callout = text_callout(
            "Test", "Arial", "normal", 
            height=0.0, width=0.0, font_size=0.0
        )
    ...
    def test_square_callout_extreme_tail_positions(self):
        ...
        callout = square_callout(
            "Test", "Arial", "normal",
            tail_x=999999.0, tail_y=888888.0
        )
